...
MESSAGE_LIMIT = 220  # The real limiting factor seems to be total transaction size
...
def create_pushdata(list_of_pushdata):
    ...
    # Old syntax - list of tuples
        ...
        # Fuck you csw and your holy asshole CG.

        if len(pushdata) > MESSAGE_LIMIT:
            raise ValueError(
                "Total bytes in OP_RETURN cannot exceed 220b ")
