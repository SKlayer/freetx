...
class CoingeckoRates:
    SINGLE_RATE = 'https://api.coingecko.com/api/v3/simple/price?ids=freecash&vs_currencies=%s&include_market_cap=false'
...
class RatesAPI:
    ...
    USD_RATES = [CoingeckoRates.usd_to_satoshi]
    EUR_RATES = [CoingeckoRates.eur_to_satoshi]
    GBP_RATES = [CoingeckoRates.gbp_to_satoshi]
    JPY_RATES = [CoingeckoRates.jpy_to_satoshi]
    CNY_RATES = [CoingeckoRates.cny_to_satoshi]
    HKD_RATES = [CoingeckoRates.hkd_to_satoshi]
    CAD_RATES = [CoingeckoRates.cad_to_satoshi]
    AUD_RATES = [CoingeckoRates.aud_to_satoshi]
    NZD_RATES = [CoingeckoRates.nzd_to_satoshi]
    RUB_RATES = [CoingeckoRates.rub_to_satoshi]
    BRL_RATES = [CoingeckoRates.brl_to_satoshi]
    CHF_RATES = [CoingeckoRates.chf_to_satoshi]
    SEK_RATES = [CoingeckoRates.sek_to_satoshi]
    DKK_RATES = [CoingeckoRates.dkk_to_satoshi]
    ISK_RATES = [CoingeckoRates.isk_to_satoshi]
    PLN_RATES = [CoingeckoRates.pln_to_satoshi]
    KRW_RATES = [CoingeckoRates.krw_to_satoshi]
    CLP_RATES = [CoingeckoRates.clp_to_satoshi]
    SGD_RATES = [CoingeckoRates.sgd_to_satoshi]
    THB_RATES = [CoingeckoRates.thb_to_satoshi]
    TWD_RATES = [CoingeckoRates.twd_to_satoshi]
    MXN_RATES = [CoingeckoRates.mxn_to_satoshi]
    ARS_RATES = [CoingeckoRates.ars_to_satoshi]
    COP_RATES = [CoingeckoRates.cop_to_satoshi]
    CUP_RATES = [CoingeckoRates.cup_to_satoshi]
    PEN_RATES = [CoingeckoRates.pen_to_satoshi]
    UYU_RATES = [CoingeckoRates.uyu_to_satoshi]
    BOB_RATES = [CoingeckoRates.bob_to_satoshi]
    DOP_RATES = [CoingeckoRates.dop_to_satoshi]
