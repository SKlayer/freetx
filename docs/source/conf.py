...
# -*- coding: utf-8 -*-
#
# freetx documentation build configuration file, created by
...
from freetx import __version__
...
latex_documents = [
    (master_doc, 'freetx.tex', 'freetx Documentation',
...
man_pages = [
    (master_doc, 'freetx', 'freetx Documentation',
     [author], 1)
]
